...
export default function PageKkRegister() {
  useEffect(() => {
      ...
      .rn-footer__contact a:hover { color: #fff; }` }} />
        ...
        <div className="rn-nav-wrap">
          <nav className="rn-nav">
            <a href="/kk" className="rn-nav__logo">
              <img src="/images/149/15248642/logo2-eaRu4CpcSUUG0yx_VFAUbA.png" alt="NEScO" />
            </a>
            <ul className="rn-nav__menu" id="navMenu">
              <li><a href="/kk/team">Топ</a></li>
              <li><a href="/kk#ed-647200767">Әріптестер</a></li>
              <li><a href="/kk#ed-647200797">Контактілер</a></li>
              <li><a href="/kk/register" className="highlight">Тіркелу</a></li>
            </ul>
            <div style={{display: 'flex', alignItems: 'center', gap: '1rem'}}>
              <div className="rn-nav__langs">
                <a href="/kk/register" className="active">KZ</a>
                <a href="/en/register">EN</a>
                <a href="/ru/register">RU</a>
              </div>
              <button className="rn-nav__burger" id="burgerBtn" aria-label="Мәзір">
                <span /><span /><span />
              </button>
            </div>
          </nav>
            ...
            <form id="regForm" noValidate>
              ...
              <div className="rn-grid">
                <div className="rn-field rn-full">
                  <label htmlFor="teamName">Команда атауы *</label>
                  <input type="text" id="teamName" name="team_name" placeholder="Бірегей атауды енгізіңіз" required />
                </div>
              </div>
              ...
              <div className="rn-section">
                ...
                <h2 className="rn-section__title">1-ші қатысушы (Капитан)</h2>
              </div>
              <div className="rn-grid">
                <div className="rn-field">
                  <label htmlFor="p1Name">Аты-жөні *</label>
                  <input type="text" id="p1Name" name="p1_name" placeholder="Тегі Аты Әкесінің аты" required />
                </div>
                <div className="rn-field">
                ...
                <div className="rn-field rn-full">
                  <label htmlFor="p1School">Мектеп *</label>
                  <input type="text" id="p1School" name="p1_school" placeholder="Мектеп атауы және қаласы" required />
                </div>
              </div>
              ...
              <div className="rn-section">
                ...
                <h2 className="rn-section__title">2-ші қатысушы</h2>
              </div>
              <div className="rn-grid">
                <div className="rn-field">
              ...
              <div className="rn-section">
                ...
                <h2 className="rn-section__title">3-ші қатысушы</h2>
              </div>
              <div className="rn-grid">
                <div className="rn-field">
              ...
              <div className="rn-section">
                ...
                <h2 className="rn-section__title">4-ші қатысушы</h2>
              </div>
              <div className="rn-grid">
                <div className="rn-field">
